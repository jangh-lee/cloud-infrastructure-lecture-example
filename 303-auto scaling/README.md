# 303 Auto Scaling Hands-on (2)

303는 003번 Web 서버를 이미지로 만들어 Public Application Load Balancer 뒤에서 Auto Scaling하는 심화 실습입니다. Backend와 DB는 기존 고정 서버를 그대로 사용합니다.

## 실습 시작

### [303 Auto Scaling 전체 교재 열기](https://jangh-lee.github.io/cloud-infrastructure-lecture-example/labs/303-auto-scaling/)
...
| 구분 | 위치 |
| --- | --- |
| 전체 실습 교재 | [GitBook 303](https://jangh-lee.github.io/cloud-infrastructure-lecture-example/labs/303-auto-scaling/) |
| 교재 원본 | [`gitbook/labs/303-auto-scaling.md`](../gitbook/labs/303-auto-scaling.md) |
