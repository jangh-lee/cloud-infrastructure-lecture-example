...
!!! info "교재와 예제 코드 연결"
    이 페이지가 015 Auto Scaling 실습의 **정본 교재**입니다. 처음부터 마지막 완료 기준까지 이 페이지 하나만 보고 진행할 수 있습니다.

    - [GitHub 015 실습 폴더](https://github.com/jangh-lee/cloud-infrastructure-lecture-example/tree/main/015-auto%20scaling)
    - [007 게시판 Backend 코드](https://github.com/jangh-lee/cloud-infrastructure-lecture-example/tree/main/007-three%20tier%20web%20app/backend)
    - [012 Cloud DB Migration 교재](https://jangh-lee.github.io/cloud-infrastructure-lecture-example/labs/012-cloud-db-migration/)
...
Target Group HTTP :4000
      |
      v
Auto Scaling Backend 1~3대 (007 Node.js)
      |
      v
...
기존 007 Web 서버와 012 Cloud DB를 다음 실습에서 사용할 경우 삭제하지 않습니다.
