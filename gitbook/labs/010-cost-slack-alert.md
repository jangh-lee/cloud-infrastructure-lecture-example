...
```text
010-cost slack alert/dist/ncp-billing.zip
```

다시 만들기:

```bash
cd "010-cost slack alert"
...
```text
010-cost slack alert/examples/object-storage-checksum.py
```
...
- 상세 자료는 저장소의 `010-cost slack alert/README.md`를 확인합니다.
