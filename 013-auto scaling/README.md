...
013은 003번 Web 서버를 이미지로 만들어 Public Application Load Balancer 뒤에서 Auto Scaling하는 실습입니다. Backend와 DB는 기존 고정 서버를 그대로 사용합니다.

## 실습 시작

### [013 Web Auto Scaling 전체 교재 열기](https://jangh-lee.github.io/cloud-infrastructure-lecture-example/labs/013-auto-scaling/)
